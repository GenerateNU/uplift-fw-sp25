...
module top ;
	...
	wire [0:0] tmpOE__DIR_FRONT_LEFT_net;
	wire [0:0] tmpFB_0__DIR_FRONT_LEFT_net;
	wire [0:0] tmpIO_0__DIR_FRONT_LEFT_net;
	wire [0:0] tmpINTERRUPT_0__DIR_FRONT_LEFT_net;
	electrical [0:0] tmpSIOVREF__DIR_FRONT_LEFT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9d9ddb8c-9fa9-42cc-b750-bfa8b45dfdde"),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_FRONT_LEFT
		 (.oe(tmpOE__DIR_FRONT_LEFT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_FRONT_LEFT_net[0:0]}),
		  .io({tmpIO_0__DIR_FRONT_LEFT_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_FRONT_LEFT_net),
		  .interrupt({tmpINTERRUPT_0__DIR_FRONT_LEFT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_FRONT_LEFT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DIR_REAR_LEFT_net;
	wire [0:0] tmpFB_0__DIR_REAR_LEFT_net;
	wire [0:0] tmpIO_0__DIR_REAR_LEFT_net;
	wire [0:0] tmpINTERRUPT_0__DIR_REAR_LEFT_net;
	electrical [0:0] tmpSIOVREF__DIR_REAR_LEFT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("37b8dd2b-e7f8-4b5c-949f-8399eb11eb26"),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_REAR_LEFT
		 (.oe(tmpOE__DIR_REAR_LEFT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_REAR_LEFT_net[0:0]}),
		  .io({tmpIO_0__DIR_REAR_LEFT_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_REAR_LEFT_net),
		  .interrupt({tmpINTERRUPT_0__DIR_REAR_LEFT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_REAR_LEFT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
