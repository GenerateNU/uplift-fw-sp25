...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=10, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=20, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=BUZZER_PWM_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BUZZER_PWM_0, CY_INSTANCE_SHORT_NAME=BUZZER_PWM_0, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=BUZZER_PWM_0, )
module PWM_v3_30_2 (
    capture,
    clock,
    cmp_sel,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=16, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=32, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_FRONT_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_FRONT_0, CY_INSTANCE_SHORT_NAME=PWM_FRONT_0, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_FRONT_0, )
module PWM_v3_30_3 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	wire [0:0] tmpOE__PWM_REAR_net;
	wire [0:0] tmpFB_0__PWM_REAR_net;
	wire [0:0] tmpIO_0__PWM_REAR_net;
	wire [0:0] tmpINTERRUPT_0__PWM_REAR_net;
	electrical [0:0] tmpSIOVREF__PWM_REAR_net;

	cy_psoc3_pins_v1_10
		#(.id("a88ef9da-8138-4de5-b0a2-fd6569925edf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_REAR
		 (.oe(tmpOE__PWM_REAR_net),
		  .y({Net_231}),
		  .fb({tmpFB_0__PWM_REAR_net[0:0]}),
		  .io({tmpIO_0__PWM_REAR_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_REAR_net),
		  .interrupt({tmpINTERRUPT_0__PWM_REAR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_REAR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 PWM_REAR_0 (
        ...
        .tc(Net_7587),
        .trigger(1'b0));
    defparam PWM_REAR_0.Resolution = 8;


	cy_clock_v1_0
		#(.id("ec1c5d3b-8ab0-4a9d-81cf-f4ef782546f5"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("5000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__DIR_FRONT_net;
	wire [0:0] tmpFB_0__DIR_FRONT_net;
	wire [0:0] tmpIO_0__DIR_FRONT_net;
	wire [0:0] tmpINTERRUPT_0__DIR_FRONT_net;
	electrical [0:0] tmpSIOVREF__DIR_FRONT_net;

	cy_psoc3_pins_v1_10
		#(.id("9d9ddb8c-9fa9-42cc-b750-bfa8b45dfdde"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_FRONT
		 (.oe(tmpOE__DIR_FRONT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_FRONT_net[0:0]}),
		  .io({tmpIO_0__DIR_FRONT_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_FRONT_net),
		  .interrupt({tmpINTERRUPT_0__DIR_FRONT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_FRONT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DIR_FRONT_RIGHT_net;
	wire [0:0] tmpFB_0__DIR_FRONT_RIGHT_net;
	wire [0:0] tmpIO_0__DIR_FRONT_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__DIR_FRONT_RIGHT_net;
	electrical [0:0] tmpSIOVREF__DIR_FRONT_RIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("ba8b71bc-3a59-46d5-b7f5-a456b85a3c32"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_FRONT_RIGHT
		 (.oe(tmpOE__DIR_FRONT_RIGHT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_FRONT_RIGHT_net[0:0]}),
		  .io({tmpIO_0__DIR_FRONT_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_FRONT_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__DIR_FRONT_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_FRONT_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DIR_REAR_net;
	wire [0:0] tmpFB_0__DIR_REAR_net;
	wire [0:0] tmpIO_0__DIR_REAR_net;
	wire [0:0] tmpINTERRUPT_0__DIR_REAR_net;
	electrical [0:0] tmpSIOVREF__DIR_REAR_net;

	cy_psoc3_pins_v1_10
		#(.id("37b8dd2b-e7f8-4b5c-949f-8399eb11eb26"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_REAR
		 (.oe(tmpOE__DIR_REAR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_REAR_net[0:0]}),
		  .io({tmpIO_0__DIR_REAR_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_REAR_net),
		  .interrupt({tmpINTERRUPT_0__DIR_REAR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_REAR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DIR_REAR_RIGHT_net;
	wire [0:0] tmpFB_0__DIR_REAR_RIGHT_net;
	wire [0:0] tmpIO_0__DIR_REAR_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__DIR_REAR_RIGHT_net;
	electrical [0:0] tmpSIOVREF__DIR_REAR_RIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("dd4571ca-6ece-4e36-a524-7e4241a93bb7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_REAR_RIGHT
		 (.oe(tmpOE__DIR_REAR_RIGHT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIR_REAR_RIGHT_net[0:0]}),
		  .io({tmpIO_0__DIR_REAR_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_REAR_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__DIR_REAR_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_REAR_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENABLE_FRONT_MOTORS_net;
	wire [0:0] tmpFB_0__ENABLE_FRONT_MOTORS_net;
	wire [0:0] tmpIO_0__ENABLE_FRONT_MOTORS_net;
	wire [0:0] tmpINTERRUPT_0__ENABLE_FRONT_MOTORS_net;
	electrical [0:0] tmpSIOVREF__ENABLE_FRONT_MOTORS_net;

	cy_psoc3_pins_v1_10
		#(.id("bb61b3df-2dd7-453d-b307-c1e02fce1e81"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ENABLE_FRONT_MOTORS
		 (.oe(tmpOE__ENABLE_FRONT_MOTORS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ENABLE_FRONT_MOTORS_net[0:0]}),
		  .io({tmpIO_0__ENABLE_FRONT_MOTORS_net[0:0]}),
		  .siovref(tmpSIOVREF__ENABLE_FRONT_MOTORS_net),
		  .interrupt({tmpINTERRUPT_0__ENABLE_FRONT_MOTORS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENABLE_FRONT_MOTORS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CURRENT_SENSE_EN_net;
	wire [0:0] tmpFB_0__CURRENT_SENSE_EN_net;
	wire [0:0] tmpIO_0__CURRENT_SENSE_EN_net;
	wire [0:0] tmpINTERRUPT_0__CURRENT_SENSE_EN_net;
	electrical [0:0] tmpSIOVREF__CURRENT_SENSE_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("35d98913-01d9-42c1-9fc4-dbab22766682"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CURRENT_SENSE_EN
		 (.oe(tmpOE__CURRENT_SENSE_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CURRENT_SENSE_EN_net[0:0]}),
		  .io({tmpIO_0__CURRENT_SENSE_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__CURRENT_SENSE_EN_net),
		  .interrupt({tmpINTERRUPT_0__CURRENT_SENSE_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CURRENT_SENSE_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3dcfc42f-56a4-43c8-ba19-aec321126850"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c38dbb7b-f964-4ed8-a393-996685ea0154"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("93eed29e-36c3-43ea-9d2d-93ad346df2d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("eb681b5d-7ca7-4a8e-9a35-e1972d237c9b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BUTTON_TILT_EN_net;
	wire [0:0] tmpFB_0__BUTTON_TILT_EN_net;
	wire [0:0] tmpIO_0__BUTTON_TILT_EN_net;
	wire [0:0] tmpINTERRUPT_0__BUTTON_TILT_EN_net;
	electrical [0:0] tmpSIOVREF__BUTTON_TILT_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("531da474-027b-494c-8c76-05e4dd96b892"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUTTON_TILT_EN
		 (.oe(tmpOE__BUTTON_TILT_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUTTON_TILT_EN_net[0:0]}),
		  .io({tmpIO_0__BUTTON_TILT_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUTTON_TILT_EN_net),
		  .interrupt({tmpINTERRUPT_0__BUTTON_TILT_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUTTON_TILT_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUTTON_MOTOR_EN_net;
	wire [0:0] tmpFB_0__BUTTON_MOTOR_EN_net;
	wire [0:0] tmpIO_0__BUTTON_MOTOR_EN_net;
	wire [0:0] tmpINTERRUPT_0__BUTTON_MOTOR_EN_net;
	electrical [0:0] tmpSIOVREF__BUTTON_MOTOR_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("8256e678-dfbc-4ed3-9cdd-2134f567c900"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUTTON_MOTOR_EN
		 (.oe(tmpOE__BUTTON_MOTOR_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUTTON_MOTOR_EN_net[0:0]}),
		  .io({tmpIO_0__BUTTON_MOTOR_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUTTON_MOTOR_EN_net),
		  .interrupt({tmpINTERRUPT_0__BUTTON_MOTOR_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUTTON_MOTOR_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUTTON_DIR_UP_net;
	wire [0:0] tmpFB_0__BUTTON_DIR_UP_net;
	wire [0:0] tmpIO_0__BUTTON_DIR_UP_net;
	wire [0:0] tmpINTERRUPT_0__BUTTON_DIR_UP_net;
	electrical [0:0] tmpSIOVREF__BUTTON_DIR_UP_net;

	cy_psoc3_pins_v1_10
		#(.id("941c61e4-90b9-4766-b32c-f3d6fdc2b7ea"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUTTON_DIR_UP
		 (.oe(tmpOE__BUTTON_DIR_UP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUTTON_DIR_UP_net[0:0]}),
		  .io({tmpIO_0__BUTTON_DIR_UP_net[0:0]}),
		  .siovref(tmpSIOVREF__BUTTON_DIR_UP_net),
		  .interrupt({tmpINTERRUPT_0__BUTTON_DIR_UP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUTTON_DIR_UP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUTTON_DIR_DOWN_net;
	wire [0:0] tmpFB_0__BUTTON_DIR_DOWN_net;
	wire [0:0] tmpIO_0__BUTTON_DIR_DOWN_net;
	wire [0:0] tmpINTERRUPT_0__BUTTON_DIR_DOWN_net;
	electrical [0:0] tmpSIOVREF__BUTTON_DIR_DOWN_net;

	cy_psoc3_pins_v1_10
		#(.id("ff39c514-cbad-4747-b006-cfabb9fe4ca9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUTTON_DIR_DOWN
		 (.oe(tmpOE__BUTTON_DIR_DOWN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUTTON_DIR_DOWN_net[0:0]}),
		  .io({tmpIO_0__BUTTON_DIR_DOWN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUTTON_DIR_DOWN_net),
		  .interrupt({tmpINTERRUPT_0__BUTTON_DIR_DOWN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUTTON_DIR_DOWN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_2 BUZZER_PWM_0 (
        .capture(1'b0),
        .clock(Net_45),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_7599),
        .trigger(1'b0));
    defparam BUZZER_PWM_0.Resolution = 8;
	...
	wire [0:0] tmpOE__ENABLE_REAR_MOTORS_net;
	wire [0:0] tmpFB_0__ENABLE_REAR_MOTORS_net;
	wire [0:0] tmpIO_0__ENABLE_REAR_MOTORS_net;
	wire [0:0] tmpINTERRUPT_0__ENABLE_REAR_MOTORS_net;
	electrical [0:0] tmpSIOVREF__ENABLE_REAR_MOTORS_net;

	cy_psoc3_pins_v1_10
		#(.id("39182708-5ee9-430e-9635-33a6f17abb0e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ENABLE_REAR_MOTORS
		 (.oe(tmpOE__ENABLE_REAR_MOTORS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ENABLE_REAR_MOTORS_net[0:0]}),
		  .io({tmpIO_0__ENABLE_REAR_MOTORS_net[0:0]}),
		  .siovref(tmpSIOVREF__ENABLE_REAR_MOTORS_net),
		  .interrupt({tmpINTERRUPT_0__ENABLE_REAR_MOTORS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENABLE_REAR_MOTORS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_3 PWM_FRONT_0 (
        ...
        .tc(Net_7611),
        .trigger(1'b0));
    defparam PWM_FRONT_0.Resolution = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("2c524990-b5b3-4cc5-9829-093a6efd945c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__LIMIT_SWITCH_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUZZER_EN_net;
	wire [0:0] tmpFB_0__BUZZER_EN_net;
	wire [0:0] tmpIO_0__BUZZER_EN_net;
	wire [0:0] tmpINTERRUPT_0__BUZZER_EN_net;
	electrical [0:0] tmpSIOVREF__BUZZER_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("510e712c-732b-49fd-9447-eca6ff51ed9c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUZZER_EN
		 (.oe(tmpOE__BUZZER_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUZZER_EN_net[0:0]}),
		  .io({tmpIO_0__BUZZER_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUZZER_EN_net),
		  .interrupt({tmpINTERRUPT_0__BUZZER_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LIMIT_SWITCH_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__BUZZER_PWM_net;
	wire [0:0] tmpFB_0__BUZZER_PWM_net;
	wire [0:0] tmpIO_0__BUZZER_PWM_net;
	wire [0:0] tmpINTERRUPT_0__BUZZER_PWM_net;
	electrical [0:0] tmpSIOVREF__BUZZER_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("8ae0451b-5108-442b-8d92-05870e027918"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUZZER_PWM
		 (.oe(tmpOE__BUZZER_PWM_net),
		  .y({Net_1020}),
		  .fb({tmpFB_0__BUZZER_PWM_net[0:0]}),
		  .io({tmpIO_0__BUZZER_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__BUZZER_PWM_net),
		  .interrupt({tmpINTERRUPT_0__BUZZER_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUZZER_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_13_net;
	wire [0:0] tmpFB_0__GPIO_13_net;
	wire [0:0] tmpIO_0__GPIO_13_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_13_net;
	electrical [0:0] tmpSIOVREF__GPIO_13_net;

	cy_psoc3_pins_v1_10
		#(.id("2362cde2-497d-4613-992c-a570a860924a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_13
		 (.oe(tmpOE__GPIO_13_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_13_net[0:0]}),
		  .io({tmpIO_0__GPIO_13_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_13_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIO_13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PSOC_ALERT_net;
	wire [0:0] tmpFB_0__PSOC_ALERT_net;
	wire [0:0] tmpIO_0__PSOC_ALERT_net;
	wire [0:0] tmpINTERRUPT_0__PSOC_ALERT_net;
	electrical [0:0] tmpSIOVREF__PSOC_ALERT_net;

	cy_psoc3_pins_v1_10
		#(.id("a8dc09b6-04f7-4450-9b6b-c08fdd92f158"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PSOC_ALERT
		 (.oe(tmpOE__PSOC_ALERT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PSOC_ALERT_net[0:0]}),
		  .io({tmpIO_0__PSOC_ALERT_net[0:0]}),
		  .siovref(tmpSIOVREF__PSOC_ALERT_net),
		  .interrupt({tmpINTERRUPT_0__PSOC_ALERT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PSOC_ALERT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_36_net;
	wire [0:0] tmpFB_0__GPIO_36_net;
	wire [0:0] tmpIO_0__GPIO_36_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_36_net;
	electrical [0:0] tmpSIOVREF__GPIO_36_net;

	cy_psoc3_pins_v1_10
		#(.id("38990431-5677-4e15-862d-7026185cff52"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_36
		 (.oe(tmpOE__GPIO_36_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_36_net[0:0]}),
		  .io({tmpIO_0__GPIO_36_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_36_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_36_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIO_36_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_30_net;
	wire [0:0] tmpFB_0__GPIO_30_net;
	wire [0:0] tmpIO_0__GPIO_30_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_30_net;
	electrical [0:0] tmpSIOVREF__GPIO_30_net;

	cy_psoc3_pins_v1_10
		#(.id("f4a216f0-1873-47e6-9444-ace5e1fffd5e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_30
		 (.oe(tmpOE__GPIO_30_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_30_net[0:0]}),
		  .io({tmpIO_0__GPIO_30_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_30_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_30_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIO_30_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c5827a74-92e3-45cc-aa2a-febf50148b0c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CURRENT_SENSE_3_net;
	wire [0:0] tmpIO_0__CURRENT_SENSE_3_net;
	wire [0:0] tmpINTERRUPT_0__CURRENT_SENSE_3_net;
	electrical [0:0] tmpSIOVREF__CURRENT_SENSE_3_net;

	cy_psoc3_pins_v1_10
		#(.id("498456a7-7750-4e63-911d-235a9d91cf16"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CURRENT_SENSE_3
		 (.oe(tmpOE__CURRENT_SENSE_3_net),
		  .y({1'b0}),
		  .fb({Net_594}),
		  .io({tmpIO_0__CURRENT_SENSE_3_net[0:0]}),
		  .siovref(tmpSIOVREF__CURRENT_SENSE_3_net),
		  .interrupt({tmpINTERRUPT_0__CURRENT_SENSE_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CURRENT_SENSE_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CURRENT_SENSE_4_net;
	wire [0:0] tmpIO_0__CURRENT_SENSE_4_net;
	wire [0:0] tmpINTERRUPT_0__CURRENT_SENSE_4_net;
	electrical [0:0] tmpSIOVREF__CURRENT_SENSE_4_net;

	cy_psoc3_pins_v1_10
		#(.id("c29e1fd5-429c-4c6e-b847-37383d416b81"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CURRENT_SENSE_4
		 (.oe(tmpOE__CURRENT_SENSE_4_net),
		  .y({1'b0}),
		  .fb({Net_607}),
		  .io({tmpIO_0__CURRENT_SENSE_4_net[0:0]}),
		  .siovref(tmpSIOVREF__CURRENT_SENSE_4_net),
		  .interrupt({tmpINTERRUPT_0__CURRENT_SENSE_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
