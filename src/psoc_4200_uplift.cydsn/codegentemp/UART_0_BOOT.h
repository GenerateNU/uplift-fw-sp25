...
/* Enable UART bootloader communication */
       ...
       #define UART_0_UART_BTLDR_COMM_ENABLED    (UART_0_BTLDR_COMM_ENABLED && \
                                                            (UART_0_SCB_MODE_UNCONFIG_CONST_CFG || \
                                                             (UART_0_UART_RX_DIRECTION && \
                                                              UART_0_UART_TX_DIRECTION)))
#else
...
***************************************/
    ...
    /* Map I2C specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_0_CyBtldrCommStart   UART_0_I2CCyBtldrCommStart
        #define UART_0_CyBtldrCommStop    UART_0_I2CCyBtldrCommStop
        #define UART_0_CyBtldrCommReset   UART_0_I2CCyBtldrCommReset
        #define UART_0_CyBtldrCommRead    UART_0_I2CCyBtldrCommRead
        #define UART_0_CyBtldrCommWrite   UART_0_I2CCyBtldrCommWrite
    ...
    #if (UART_0_SCB_MODE_EZI2C_CONST_CFG)
        #define UART_0_CyBtldrCommStart   UART_0_EzI2CCyBtldrCommStart
        #define UART_0_CyBtldrCommStop    UART_0_EzI2CCyBtldrCommStop
        #define UART_0_CyBtldrCommReset   UART_0_EzI2CCyBtldrCommReset
        #define UART_0_CyBtldrCommRead    UART_0_EzI2CCyBtldrCommRead
        #define UART_0_CyBtldrCommWrite   UART_0_EzI2CCyBtldrCommWrite
    #endif /* (UART_0_SCB_MODE_EZI2C_CONST_CFG) */
    ...
    /* Map SPI specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_0_CyBtldrCommStart   UART_0_SpiCyBtldrCommStart
        #define UART_0_CyBtldrCommStop    UART_0_SpiCyBtldrCommStop
        #define UART_0_CyBtldrCommReset   UART_0_SpiCyBtldrCommReset
        #define UART_0_CyBtldrCommRead    UART_0_SpiCyBtldrCommRead
        #define UART_0_CyBtldrCommWrite   UART_0_SpiCyBtldrCommWrite
    ...
    /* Map UART specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_0_CyBtldrCommStart   UART_0_UartCyBtldrCommStart
        #define UART_0_CyBtldrCommStop    UART_0_UartCyBtldrCommStop
        #define UART_0_CyBtldrCommReset   UART_0_UartCyBtldrCommReset
        #define UART_0_CyBtldrCommRead    UART_0_UartCyBtldrCommRead
        #define UART_0_CyBtldrCommWrite   UART_0_UartCyBtldrCommWrite
...
#define UART_0_BYTES_TO_COPY(actBufSize, bufSize) \
...
*/
#ifndef UART_0_SPI_BYTE_TO_BYTE
    #define UART_0_SPI_BYTE_TO_BYTE   (160u)
#endif

/* Byte to byte time interval: calculated basing on current component
* baud rate configuration, can be defined in the project if required.
*/
#ifndef UART_0_UART_BYTE_TO_BYTE
    #define UART_0_UART_BYTE_TO_BYTE  (171u)
#endif /* UART_0_UART_BYTE_TO_BYTE */
