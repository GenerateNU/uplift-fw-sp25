...
*******************************************************************************/
    ...
    #pragma location=".bootloader"
           ...
           const uint8  CYCODE Bootloader_0_Checksum = 0u;
#elif defined (__ICCARM__)
    __root const uint8  CYCODE Bootloader_0_Checksum = 0u;
#endif  /* defined(__ARMCC_VERSION) || defined (__GNUC__) || defined (__C51__) */
const uint8  CYCODE *Bootloader_0_ChecksumAccess  = (const uint8  CYCODE *)(&Bootloader_0_Checksum);

#if defined(__ARMCC_VERSION) || defined (__GNUC__)
    __attribute__((section (".bootloader"), used))
    const uint32 CYCODE Bootloader_0_SizeBytes = 0xFFFFFFFFu;
#elif defined (__ICCARM__)
    #pragma location=".bootloader"
    __root const uint32 CYCODE Bootloader_0_SizeBytes = 0xFFFFFFFFu;
#elif defined (__C51__)
    const uint32 CYCODE Bootloader_0_SizeBytes = 0xFFFFFFFFu;
#endif  /* defined(__ARMCC_VERSION) || defined (__GNUC__) */

const uint32 CYCODE *Bootloader_0_SizeBytesAccess = (const uint32 CYCODE *)(&Bootloader_0_SizeBytes);
 ...
 *  Bootloader_0_Initialize() function. Once the initialization is done,
 *  the variable is set and this prevents the functionality from reinitialization.
 */
uint8 Bootloader_0_initVar = Bootloader_0_BOOTLOADING_NOT_INITIALIZED;

/**
 *  This variable is intended to keep the current application number. It applies
 *  only to in-application bootloading.
 */
uint8 Bootloader_0_runningApp = Bootloader_0_RUNNING_APPLICATION_UNKNOWN;
 ...
 */
uint8 Bootloader_0_isBootloading = Bootloader_0_BOOTLOADING_COMPLETED;
#endif /*CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER*/
 ...
 */
volatile uint8 Bootloader_0_activeApp = Bootloader_0_MD_BTLDB_ACTIVE_NONE;
#else /*SINGLE-APP BOOTLOADER*/
    #define Bootloader_0_activeApp      (Bootloader_0_MD_BTLDB_ACTIVE_0)
 ...
 */
static const uint8 CYCODE Bootloader_0_securityKey[Bootloader_0_SECURITY_KEY_LENGTH] = {0x11u, 0x22u, 0x33u, 0x44u, 0x55u, 0x66u};
 ...
 */
static Bootloader_0_callback_type Bootloader_0_callback = NULL;
...
***************************************/
#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
    static void  Bootloader_0_LaunchApplication(void) CYSMALL \
                    ; 
#if(!CY_PSOC3)
    /* Implementation for PSoC 3 resides in Bootloader_psoc3.a51 file.  */
    static void     Bootloader_0_LaunchBootloadable(uint32 appAddr);
#endif  /* (!CY_PSOC3) */
#endif /* CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER */ 

#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)
    static cystatus Bootloader_0_WritePacket(uint8 status, uint8 buffer[], uint16 size) CYSMALL \
                                    ;

    static uint16   Bootloader_0_CalcPacketChecksum(const uint8 buffer[], uint16 size) CYSMALL \
                                    ;
                                    
    #if (0u != Bootloader_0_CMD_VERIFY_FLS_ROW_AVAIL)
    static uint8 Bootloader_0_VerifyRow(uint32 flashStart, const uint8 ramStart[], uint16 size) \
                CYSMALL ;                                
    #endif /*(0u != Bootloader_0_CMD_VERIFY_FLS_ROW_AVAIL)*/            

#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)                                    
    static void Bootloader_0_HostLink(uint8 timeOut) CYLARGE ;
#endif /* (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) */                                    
#endif /*(CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)*/
                                    
#if (((0u != Bootloader_0_DUAL_APP_BOOTLOADER) && (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)) \
                                          || (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))
    static uint8 Bootloader_0_CheckImage(uint8 appNumber, uint8 arrayNumber, uint16 row, uint16 rowNumInArray) CYSMALL \
                                    ;                                    
#endif /*(((0u != Bootloader_0_DUAL_APP_BOOTLOADER) && (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)) \
                                          || (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))*/

#if ((CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) || (0u != Bootloader_0_DUAL_APP_BOOTLOADER)) 
    static void Bootloader_0_SetActiveAppInMetadata(uint8 activeApp) CYSMALL \
                ;
#endif /* (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) || (0u != Bootloader_0_DUAL_APP_BOOTLOADER) */                     

#if ((CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) || \
     (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_MULTIAPPBOOTLOADER) || \
     (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER))
    static uint8 Bootloader_0_GetActiveAppFromMetadata(void) CYSMALL \
                ;                     
#endif /*((CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) || \
          (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_MULTIAPPBOOTLOADER) || \
          (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER)) */
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER)
#if ((0u != Bootloader_0_COPIER_AVAIL) && (CY_PSOC4)) 
    static cystatus Bootloader_0_CopyRow(uint16 srcRowNum, uint16 dstRowNum) \
                 CYSMALL ;
    static void Bootloader_0_Copier(void) CYSMALL ;
#endif /*(0u != Bootloader_0_COPIER_AVAIL) && (CY_PSOC4)*/
#endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER)*/
...
*/
#if ((CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) || \
                                  (0u != Bootloader_0_DUAL_APP_BOOTLOADER))                                          
/*******************************************************************************
* Function Name: Bootloader_0_SetActiveAppInMetadata
****************************************************************************//**
* \internal
*
* \brief
...
{
    if (Bootloader_0_MD_BTLDB_ACTIVE_NONE > activeApp)
    {
        uint8 CYDATA idx;    
    #if(!CY_PSOC4)      
    ...
    #endif  /* (!CY_PSOC4) */    
        for(idx = 0u; idx < Bootloader_0_MAX_NUM_OF_BTLDB; idx++)
        {
            (void)Bootloader_0_SetFlashByte((uint32) Bootloader_0_MD_BTLDB_ACTIVE_OFFSET(idx),
                                                (uint8)(idx == activeApp));
        }
    }    
}
     ...
     (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER))                   
/*******************************************************************************
* Function Name: Bootloader_0_GetActiveAppFromMetadata
****************************************************************************//**
* \internal
*
* \brief
...
*    then Bootloader_0_MD_BTLDB_ACTIVE_NONE (0x02) is returned.
*
* \return
*   The number of active applications. In the case of error:
*   -  Bootloader_0_MD_BTLDB_ACTIVE_NONE (0x02) - neither application is initialized;
*   -  Bootloader_0_BOTH_ACTIVE (0x03) - both applications are set active;
*
* \endinternal 
*******************************************************************************/
static  uint8 Bootloader_0_GetActiveAppFromMetadata(void) CYSMALL \
...
{
    uint8 CYDATA result;
    uint8 CYDATA app0 = (uint8)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE, 
                                                     Bootloader_0_MD_BTLDB_ACTIVE_0);
    uint8 CYDATA app1 = (uint8)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE, 
                                                     Bootloader_0_MD_BTLDB_ACTIVE_1);        
    ...
    if (0u != app0)                                                     
    {
        ...
        {
            /* app0 is active */
            result = Bootloader_0_MD_BTLDB_ACTIVE_0;
        }
        else 
        {
            /* Both are active */
            result = Bootloader_0_BOTH_ACTIVE;
        }
    }
    else /* (0u == app0) */
    {
        ...
        {
            /* app1 is active */
            result = Bootloader_0_MD_BTLDB_ACTIVE_1;
        }
        else
        {
            /* Neither app is active. */
            result = Bootloader_0_MD_BTLDB_ACTIVE_NONE;
        }          
    }
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
/*******************************************************************************
* Function Name: Bootloader_0_Initialize
****************************************************************************//**
* 
* \brief 
*   Used for in-app bootloading. This function updates the global variable 
*   Bootloader_0_runningApp with a running application number.
*
*   If the running application number is valid (0 or 1), this function also 
*   sets the global variable Bootloader_0_initVar that is used to determine 
...
* \return
*   Global variables: 
*     - Bootloader_0_runningApp
*     - Bootloader_0_activeApp
*     - Bootloader_0_initVar
*
* \details 
...
{
    if (Bootloader_0_BOOTLOADING_NOT_INITIALIZED ==Bootloader_0_initVar)
    {
        Bootloader_0_activeApp = Bootloader_0_GetActiveAppFromMetadata();
        
        /* Updating with number of active application */    
        if ((Bootloader_0_MD_BTLDB_ACTIVE_NONE != Bootloader_0_activeApp) &&
            (Bootloader_0_BOTH_ACTIVE != Bootloader_0_activeApp))
        {
            Bootloader_0_runningApp = Bootloader_0_activeApp;
            
            /* Bootloader commands are to be processed */
            Bootloader_0_initVar = Bootloader_0_BOOTLADING_INITIALIZED;
        }
        else 
        {
            Bootloader_0_runningApp = Bootloader_0_RUNNING_APPLICATION_UNKNOWN;
        }
    }
}

/*****************************************************************************
* Function Name: Bootloader_0_GetRunningAppStatus
**************************************************************************//**
*
* \brief 
*   Used for dual-app or in-app bootloader. Returns the value of the global 
*   variable Bootloader_0_runningApp. This function should be called only after the 
*   Bootloader_0_Initialize() has been called once.
*
* \return 
...
{  
    return (Bootloader_0_runningApp);
}


/*******************************************************************************
* Function Name: Bootloader_0_GetActiveAppStatus
****************************************************************************//**
*
* \brief 
*   Used for dual-app or in-app bootloader. Returns the value of the global 
*   variable Bootloader_0_activeApp. This function should be called only after the 
*   Bootloader_0_Initialize() has been called once.
*
* \return 
...
{  
    ...
    return (Bootloader_0_activeApp);
}
#endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/

#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)
/*******************************************************************************
* Function Name: Bootloader_0_CalcPacketChecksum
****************************************************************************//**
*  \internal
*
*  \brief
...
*  \endinternal
*******************************************************************************/
static uint16 Bootloader_0_CalcPacketChecksum(const uint8 buffer[], uint16 size) \
                    CYSMALL 
{
    #if(0u != Bootloader_0_PACKET_CHECKSUM_CRC)

        uint16 CYDATA crc = Bootloader_0_CRC_CCITT_INITIAL_VALUE;
        uint16 CYDATA tmp;
        uint8  CYDATA i;
        ...
        else
        {
            do
            {
                ...
                for (i = 0u; i < 8u; i++)
                {
                    ...
                    {
                        crc = (crc >> 1u) ^ Bootloader_0_CRC_CCITT_POLYNOMIAL;
                    }
                    else
                    {
                        crc >>= 1u;
    ...
    #endif /* (0u != Bootloader_0_PACKET_CHECKSUM_CRC) */
}

#if (!CY_PSOC3)
/*******************************************************************************
* Function Name: Bootloader_0_InitCallback
****************************************************************************//**
*
* \brief
...
void Bootloader_0_InitCallback(Bootloader_0_callback_type userCallback) \
           CYSMALL 
{
    Bootloader_0_callback = userCallback;
}
#endif /* (!CY_PSOC3) */
...
#if (0u != Bootloader_0_CMD_VERIFY_FLS_ROW_AVAIL)
/*******************************************************************************
* Function Name: Bootloader_0_VerifyRow
****************************************************************************//**
*  \internal
* 
*  \brief
...
*  \n Bootloader_0_ERR_VERIFY - If there is any mismatch.
*
* \endinternal 
*******************************************************************************/
static uint8 Bootloader_0_VerifyRow(uint32 flashStart, const uint8 ramStart[], uint16 size) \
                CYSMALL 
{
    ...
    for(idx = 0u; idx < size; idx++)
    {
        ...
        {
            result = Bootloader_0_ERR_VERIFY;
            break;
        }    
    }
...
/*******************************************************************************
* Function Name: Bootloader_0_Calc8BitSum
****************************************************************************//**
*
* \brief
...
*
*******************************************************************************/
uint8 Bootloader_0_Calc8BitSum(uint32 baseAddr, uint32 start, uint32 size) \
                CYSMALL 
{
    uint8 CYDATA sum = 0u;
...
#if ((0u != Bootloader_0_COPIER_AVAIL) && (CY_PSOC4)) 
/*******************************************************************************
* Function Name: Bootloader_0_CopyRow
****************************************************************************//**
* \internal
*
* \brief
                 ...
                 CYSMALL 
{
    ...
    {
        rowBuffer[idx] = Bootloader_0_GET_CODE_BYTE(srcBaseAddr + idx);
    }
...
/*******************************************************************************
* Function Name: Bootloader_0_Copier
****************************************************************************//**
*  \internal
*  
*  \brief
...
*    (Bootloader_0_MAX_ATTEMPTS) to try again. In case of no success, 
           ...
           
{
    ...
    uint8 copyFlag = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_COPY_FLAG, Bootloader_0_MD_BTLDB_ACTIVE_1);

    /* Buffer to temporary hold metadata before flashing */
    uint8 metaBuf[CYDEV_FLS_ROW_SIZE];

    /* Launcher's last row number */
    uint16 launcherLastRow = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW, Bootloader_0_MD_BTLDB_ACTIVE_0);
    ...
    uint32 srcLength = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_LENGTH, Bootloader_0_MD_BTLDB_ACTIVE_1);
    ...
    * perform the copying operation (a number is defined by Bootloader_0_MAX_ATTEMPTS)
    ***************************************************************************/
    for(idx = 0; idx < numberOfRows; idx++)
    {
        copierAttempts = Bootloader_0_MAX_ATTEMPTS;
        
        do 
        {
            /* Copying row */
            copyStatus = Bootloader_0_CopyRow(srcRow + idx, dstRow + idx);
        ...
        ***************************************************************************/
        if (CYRET_SUCCESS != copyStatus)
        {
            ...
            Bootloader_0_SetFlashByte(Bootloader_0_MD_BTLDB_COPY_FLAG_OFFSET(Bootloader_0_MD_BTLDB_ACTIVE_1),
                                         (copyFlag & (~Bootloader_0_NEED_TO_COPY_SET_BIT)));
                
            /* Callback macro definition */
            #if (0u != LAUNCHER_COPIER_CALLBACK)
                Bootloader_0_CopierCallback();
            #endif /* 0u != LAUNCHER_COPIER_CALLBACK */ 
            
            /*************************************************************************
            * If the copying operation was unsuccessful after certain number of attempts
            * and Bootloader_0_CopierCallback() is either undefined or returns, then the
    ...
    if (CYRET_SUCCESS == copyStatus)
    {
        ...
        ******************************************************************************/
        ...
        uint32 metaStartAddr = Bootloader_0_MD_BASE_ADDR(Bootloader_0_MD_BTLDB_ACTIVE_1) + 
                               Bootloader_0_MD_SIZEOF - CYDEV_FLS_ROW_SIZE; 
        
        /* Read all data from metadata #2 */
        for (idx = 0u; idx < CYDEV_FLS_ROW_SIZE; idx++)
        {
            metaBuf[idx] = Bootloader_0_GET_CODE_BYTE(metaStartAddr + idx);
        }
        
        /* Setting 'Copier available' flag (copyFlag field) in buffer to be stored in metadata#1 */
        metaBuf[Bootloader_0_MD_BUFFER_START_OFFSET + Bootloader_0_MD_COPY_FLAG_BYTE_OFFSET] = Bootloader_0_COPIER_SUPPORT_SET_BIT;                

        /* Set active app#1 */
        Bootloader_0_activeApp = Bootloader_0_MD_BTLDB_ACTIVE_0;
        
        /* Setting app#1 as active application in buffer to be stored in metadata#1 */
        metaBuf[Bootloader_0_MD_BUFFER_START_OFFSET + Bootloader_0_MD_ACTIVE_APP_BYTE_OFFSET] = 0x01u;      

        /* Setting app#1 as valid for 'Fast validation' to be stored in metadata#1 */
        metaBuf[Bootloader_0_MD_BUFFER_START_OFFSET + Bootloader_0_MD_FAST_VALID_BYTE_OFFSET] = 0x01u;      
    ...
    {
        /* Schedule*/
        Bootloader_0_SET_RUN_TYPE(Bootloader_0_SCHEDULE_BTLDB);
...
/*******************************************************************************
* Function Name: Bootloader_0_Start
****************************************************************************//**
* \brief
...
void Bootloader_0_Start(void) CYSMALL 
{
    ...
    #if(0u != Bootloader_0_BOOTLOADER_APP_VALIDATION)
        uint8 CYDATA calcedChecksum;
    #endif    /* (0u != Bootloader_0_BOOTLOADER_APP_VALIDATION) */

    #if(!CY_PSOC4)
        #if(0u != Bootloader_0_FAST_APP_VALIDATION)
            ...
            if (CYRET_SUCCESS != CySetTemp())
            {
                ...
                if (CYRET_SUCCESS != CySetFlashEEBuffer(Bootloader_0_flashBuffer))
                {
                    CyHalt(0x00u);
                }

                uint8 CYXDATA Bootloader_0_flashBuffer[Bootloader_0_FROW_SIZE];
            #endif /* !defined(CY_BOOT_VERSION) */
        #endif  /* (0u != Bootloader_0_FAST_APP_VALIDATION) */
    #endif  /* (!CY_PSOC4) */

    #if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER) 
    #if ((0u != Bootloader_0_COPIER_AVAIL) && (CY_PSOC4))
        /* Checking "need-to-copy" flag in metadata#1. If it is set, then copy operation is required*/            
        uint8 needToCopyFlag = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_COPY_FLAG, 
                                                        Bootloader_0_MD_BTLDB_ACTIVE_1);                                                    
        
        /* Checking "Need to copy" flag in metadata#1 */
        if (0u != (needToCopyFlag & Bootloader_0_NEED_TO_COPY_MASK))
        {
    ...
    /* Identify active Bootloadable/Combination application */
    #if (0u != Bootloader_0_DUAL_APP_BOOTLOADER)
        app0Status = Bootloader_0_ValidateBootloadable(Bootloader_0_MD_BTLDB_ACTIVE_0);
        app1Status = Bootloader_0_ValidateBootloadable(Bootloader_0_MD_BTLDB_ACTIVE_1);  

        /* Assumes no active Bootloadable application. Bootloader is active. */
        Bootloader_0_activeApp = Bootloader_0_MD_BTLDB_ACTIVE_NONE;

        /* Bootloadable app#1 is active */
        if(Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE, Bootloader_0_MD_BTLDB_ACTIVE_0) == \
                                                                           Bootloader_0_MD_BTLDB_IS_ACTIVE)
        {
            /**********************************************************************************************************
            * ---------------------------------------------------------------------------------------------------------
            ...
            **********************************************************************************************************/
            ...
            {
                #if (((1u == Bootloader_0_AUTO_SWITCHING_AVAIL) &&  \
                      (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_MULTIAPPBOOTLOADER)) || \
                      (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER)) 
                if (CYRET_SUCCESS == app1Status )
                {
                    /* Cases # 10 and 12 */
                    Bootloader_0_activeApp = Bootloader_0_MD_BTLDB_ACTIVE_1;
                    validApp = CYRET_SUCCESS;
                }
                #endif /*((1u == Bootloader_0_AUTO_SWITCHING_AVAIL) && 
                          (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_MULTIAPPBOOTLOADER)) || 
                          (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER)*/
            }
        }
        ...
        if(Bootloader_0_activeApp == Bootloader_0_MD_BTLDB_ACTIVE_NONE)
        {
            /**********************************************************************************************************
            * ---------------------------------------------------------------------------------------------------------
            * |      |       app#1    |       app#2    |        Classic Dual-app       |     Launch-only Bootloader   |
            ...
            * ---------------------------------------------------------------------------------------------------------
            **********************************************************************************************************/
            if (Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE, 1u) ==
                    Bootloader_0_MD_BTLDB_IS_ACTIVE)
            {
                /* Cases # 3, 4, 7, and 8 */
                if (CYRET_SUCCESS == app1Status)
            ...
            *********************************************************************************/
            ...
            {
                Bootloader_0_SetActiveAppInMetadata(Bootloader_0_activeApp);      
            }
        #endif /* CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LAUNCHER */
    #else /*SINGLE_APP BOOTLOADER*/
        if (CYRET_SUCCESS == Bootloader_0_ValidateBootloadable(Bootloader_0_MD_BTLDB_ACTIVE_0))
        {
            validApp = CYRET_SUCCESS;
        }
    #endif  /* (0u != Bootloader_0_DUAL_APP_BOOTLOADER) */
    ...
    ***********************************************************************/
        ...
        calcedChecksum = Bootloader_0_Calc8BitSum(CY_FLASH_BASE,
                Bootloader_0_MD_BTLDR_ADDR_PTR,
                *Bootloader_0_SizeBytesAccess - Bootloader_0_MD_BTLDR_ADDR_PTR);

        /* We included checksum, so remove it */
        calcedChecksum -= *Bootloader_0_ChecksumAccess;
        calcedChecksum = ( uint8 )1u + ( uint8 )(~calcedChecksum);

        /* Checksum and pointer to Bootloader verification */
        if((calcedChecksum != *Bootloader_0_ChecksumAccess) ||
           (0u == *Bootloader_0_SizeBytesAccess))
        {
            /***********************************************************************
            * If the Bootloader/Launcher application calculated checksum does not match
            * the checksum stored in special Bootloader_0_Checksum constant 
            * (accessed through Bootloader_0_ChecksumAccess) constant or its size 
            * stored in Bootloader_0_SizeBytes constant (accessed through
            * Bootloader_0_SizeBytesAccess) then CPU is halted, all software 
            * processing stops. 
            ***********************************************************************/
            CyHalt(0x00u);
        }
    ...
    *    commands forever.
    ***********************************************************************/
    if ((Bootloader_0_GET_RUN_TYPE == Bootloader_0_SCHEDULE_BTLDR) 
#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)        
        || (CYRET_SUCCESS != validApp)
#endif        
        )
    {
        Bootloader_0_SET_RUN_TYPE(Bootloader_0_SCHEDULE_BTLDR_INIT_STATE);

        Bootloader_0_HostLink(Bootloader_0_WAIT_FOR_COMMAND_FOREVER);
    }

    /* Go to communication subroutine. Will wait for commands for specified time */
    #if(0u != Bootloader_0_WAIT_FOR_COMMAND)

        /* Timeout is in 100s of milliseconds */
        Bootloader_0_HostLink(Bootloader_0_WAIT_FOR_COMMAND_TIME);

    #endif  /* (0u != Bootloader_0_WAIT_FOR_COMMAND) */
#else /* Launcher */
    ...
    Bootloader_0_LaunchApplication();
#endif /*(CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/    
}

#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
/*******************************************************************************
* Function Name: Bootloader_0_LaunchApplication
****************************************************************************//**
* \internal
*
* \brief
...
/*******************************************************************************
* Function Name: Bootloader_0_Exit
****************************************************************************//**
*
*\brief
...
*   - Bootloader_0_EXIT_TO_BTLDR - The Bootloader application will be started on
*                                     a software reset.
*   - Bootloader_0_EXIT_TO_BTLDB;
*   - Bootloader_0_EXIT_TO_BTLDB_1 - Bootloadable application # 1 will be
*                                     started on a software reset.
*   - Bootloader_0_EXIT_TO_BTLDB_2 - Bootloadable application # 2 will be
...
{
    if(Bootloader_0_EXIT_TO_BTLDR == appId)
    {
        Bootloader_0_SET_RUN_TYPE(Bootloader_0_SCHEDULE_BTLDR_INIT_STATE);
    }
    else
    {
        if(CYRET_SUCCESS == Bootloader_0_ValidateBootloadable(appId))
        {
            /* Set active application in metadata */
            uint8 CYDATA idx;
            for(idx = 0u; idx < Bootloader_0_MAX_NUM_OF_BTLDB; idx++)
            {
                Bootloader_0_SetFlashByte((uint32) Bootloader_0_MD_BTLDB_ACTIVE_OFFSET(idx),
                                              (uint8 )(idx == appId));
            }

        #if((0u != Bootloader_0_DUAL_APP_BOOTLOADER) || \
            (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))
            Bootloader_0_activeApp = appId;
        #endif /* (0u != Bootloader_0_DUAL_APP_BOOTLOADER) || 
                  (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))*/
...
void CyBtldr_CheckLaunch(void) CYSMALL 
{
    ...
    *******************************************************************************/
    if (0u == (Bootloader_0_RES_CAUSE_REG & Bootloader_0_RES_CAUSE_RESET_SOFT))
    {
        cyBtldrRunType = Bootloader_0_SCHEDULE_BTLDR_INIT_STATE;
    }

#endif /* (CY_PSOC4) */


    if (Bootloader_0_GET_RUN_TYPE == Bootloader_0_SCHEDULE_BTLDB)
    {
        ...
        * The active application number is taken from Bootloader_0_activeApp not
        * to break backward compatibility.
        *******************************************************************************/
        uint8 activeApp = Bootloader_0_activeApp;
        ...
        * between applications. So if there is no valid value for Bootloader_0_activeApp,
        ...
        *******************************************************************************/ 
        ...
        if (activeApp >= Bootloader_0_MD_BTLDB_ACTIVE_NONE) 
        {
            activeApp = Bootloader_0_GetActiveAppFromMetadata();
        }
        ...
        uint8 activeApp = Bootloader_0_GetActiveAppFromMetadata(); 
    #endif /* (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER) */
        ...
        *******************************************************************************/
        if ((0u != Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ADDR, activeApp)) 
    #if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_BOOTLOADER)
            && (activeApp < Bootloader_0_MD_BTLDB_ACTIVE_NONE)
    #endif /* (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_BOOTLOADER) */        
            )
        {
            /* Never returns from this method */
            Bootloader_0_LaunchBootloadable(Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ADDR,
                                                                             activeApp));
        }
    }
}
...
/* Moves argument appAddr (RO) into PC, moving execution to appAddr */
    ...
    __asm static void Bootloader_0_LaunchBootloadable(uint32 appAddr)
    {
        BX  R0
        ALIGN
    }
...
/*******************************************************************************
* Function Name: Bootloader_0_ValidateBootloadable
****************************************************************************//**
* \brief
...
*******************************************************************************/
cystatus Bootloader_0_ValidateBootloadable(uint8 appId) CYSMALL \

    {
        uint32 CYDATA idx;

        uint32 CYDATA end   = Bootloader_0_FIRST_APP_BYTE(appId) +
                              Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_LENGTH, appId);
        ...
        #if(0u != Bootloader_0_FAST_APP_VALIDATION)
            if(Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_STATUS, appId) ==
               Bootloader_0_MD_BTLDB_IS_VERIFIED)
            {
        ...
        for(idx = Bootloader_0_FIRST_APP_BYTE(appId); idx < end; ++idx)
        {
            uint8 CYDATA curByte = Bootloader_0_GET_CODE_BYTE(idx);
        ...
        ***************************************************************************/
            ...
            idx = ((Bootloader_0_FIRST_APP_BYTE(appId)) >> 3u);

            /* Flash may run into meta data, so ECC does not use full row */
            end = (end == (CY_FLASH_SIZE - Bootloader_0_MD_SIZEOF))
                ? (CY_FLASH_SIZE >> 3u)
                : (end >> 3u);
        ...
        if((calcedChecksum != Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_CHECKSUM, appId)) ||
           (0u == valid))
        {
            return(CYRET_BAD_DATA);
        }
        ...
        #if(0u != Bootloader_0_FAST_APP_VALIDATION)
            Bootloader_0_SetFlashByte((uint32) Bootloader_0_MD_BTLDB_VERIFIED_OFFSET(appId),
                                          Bootloader_0_MD_BTLDB_IS_VERIFIED);
        #endif  /* (0u != Bootloader_0_FAST_APP_VALIDATION) */
        ...
        return(CYRET_SUCCESS);
                                          ...
                                          || (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))
/*******************************************************************************
* Function Name: Bootloader_0_CheckImage
********************************************************************************
* \internal
*
* \brief 
...
*   Bootloader_0_ERR_ACTIVE - Writing to this image is NOT permitted
                                         ...
                                         
{
    ...
    if (appNumber < Bootloader_0_MAX_NUM_OF_BTLDB)
    {    
        /*******************************************************************************
        ...
        *******************************************************************************/
        firstRow = (uint16) 1u +
            (uint16) Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW,  appNumber);
    ...
    ***********************************************************************************/
    ...
    #if ((CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) && \
         (0u != Bootloader_0_IS_STACK_APPLICATION))
        /*******************************************************************************
        ...
        *                |<-------------------lastRow -------------------->|
        *******************************************************************************/
        lastRow = (uint16) Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW,
                                                        Bootloader_0_USER_APPLICATION);    
        ...
        *                                         |<-------lastRow-------->|
        *******************************************************************************/
        lastRow = (uint16)(CY_FLASH_NUMBER_ROWS - Bootloader_0_NUMBER_OF_METADATA_ROWS - firstRow);
        ...
        *******************************************************************************/
        lastRow = (uint16)(lastRow / (uint8)(Bootloader_0_NUMBER_OF_BTLDBLE_APPS - appNumber));
    ...
    #endif /*(0u == Bootloader_0_IS_STACK_APPLICATION)*/    
        ...
        *
        *******************************************************************************/
        if (((row >= firstRow) && (row <= lastRow)) || ((arrayNumber == Bootloader_0_MD_FLASH_ARRAY_NUM) && \
            (rowNumInArray == Bootloader_0_MD_ROW_NUM(appNumber))))
        {
            ackCode = Bootloader_0_ERR_ACTIVE;
        }
    }
    else /*(appNumber < Bootloader_0_MAX_NUM_OF_BTLDB)*/
    {
        ackCode = Bootloader_0_ERR_ACTIVE;
    }
...
#if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)
/*******************************************************************************
* Function Name: Bootloader_0_HostLink
****************************************************************************//**
*
* \brief
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
    static  CYBIT communicationState = Bootloader_0_COMMUNICATION_STATE_IDLE; 
    static uint16 CYDATA dataOffset = 0u; 
    uint16  CYDATA btldrLastRow = 0xFFFFu;
    uint8 needToCopyFlag = 0u;
    uint32 app2StartAddress = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ADDR, 
                              Bootloader_0_MD_BTLDB_ACTIVE_1);
#else
    CYBIT     communicationState = Bootloader_0_COMMUNICATION_STATE_IDLE;
    uint16 CYDATA dataOffset = 0u; 
#endif /*CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER*/

    uint8     packetBuffer[Bootloader_0_SIZEOF_COMMAND_BUFFER];
    uint8     dataBuffer  [Bootloader_0_SIZEOF_COMMAND_BUFFER];
    ...
    do
    {
        ...
        do
        {
            readStat = CyBtldrCommRead(packetBuffer,
                                        Bootloader_0_SIZEOF_COMMAND_BUFFER,
                                        &numberRead,
        ...
        if((numberRead < Bootloader_0_MIN_PKT_SIZE) ||
           (packetBuffer[Bootloader_0_SOP_ADDR] != Bootloader_0_SOP))
        {
            ackCode = Bootloader_0_ERR_DATA;
        }
        else
        {
            pktSize = ((uint16)((uint16)packetBuffer[Bootloader_0_SIZE_ADDR + 1u] << 8u)) |
                               packetBuffer[Bootloader_0_SIZE_ADDR];
            ...
            **************************************************************************************/
            if (((pktSize + Bootloader_0_MIN_PKT_SIZE) > numberRead) || 
                ((pktSize + Bootloader_0_MIN_PKT_SIZE) > Bootloader_0_SIZEOF_COMMAND_BUFFER)) 
            {
                ackCode = Bootloader_0_ERR_LENGTH;
            }
            else /* Packet length is OK*/
            {
                pktChecksum = ((uint16)((uint16)packetBuffer[Bootloader_0_CHK_ADDR(pktSize) + 1u] << 8u)) |
                                   packetBuffer[Bootloader_0_CHK_ADDR(pktSize)];
   
                if (packetBuffer[Bootloader_0_EOP_ADDR(pktSize)] != Bootloader_0_EOP)
                {
                    ackCode = Bootloader_0_ERR_DATA;
                }
                else if(pktChecksum != Bootloader_0_CalcPacketChecksum(packetBuffer,
                                                                        pktSize + Bootloader_0_DATA_ADDR))
                {
                    ackCode = Bootloader_0_ERR_CHECKSUM;
                }
                else
                {
                    /* Empty section */
        ...
        rspSize = Bootloader_0_RSP_SIZE_0;
        if(ackCode == CYRET_SUCCESS)
        {
            uint8 CYDATA btldrData = packetBuffer[Bootloader_0_DATA_ADDR];

            ackCode = Bootloader_0_ERR_DATA;
            switch(packetBuffer[Bootloader_0_CMD_ADDR])
            {
            ...
            *   Get metadata (0x3C)
            ***************************************************************************/
            #if(0u != Bootloader_0_CMD_GET_METADATA)

                case Bootloader_0_COMMAND_GET_METADATA:

                    if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 1u))
                    {
                        if (btldrData >= Bootloader_0_MAX_NUM_OF_BTLDB)
                        {
                            ackCode = Bootloader_0_ERR_APP;
                        }
                        else if(CYRET_SUCCESS == Bootloader_0_ValidateBootloadable(btldrData))
                        {
                            #if(CY_PSOC3)
                                (void) memcpy(&packetBuffer[Bootloader_0_DATA_ADDR],
                                            ((uint8  CYCODE *) (Bootloader_0_MD_BASE_ADDR(btldrData))),
                                            (int8)Bootloader_0_GET_METADATA_RESPONSE_SIZE);
                            #else
                                (void) memcpy(&packetBuffer[Bootloader_0_DATA_ADDR],
                                            (uint8 *) Bootloader_0_MD_BASE_ADDR(btldrData),
                                            Bootloader_0_GET_METADATA_RESPONSE_SIZE);
                            #endif  /* (CY_PSOC3) */

                            rspSize = Bootloader_0_RSP_SIZE_GET_METADATA;
                            ackCode = CYRET_SUCCESS;
                        }
                        else
                        {
            ...
            #endif  /* (0u != Bootloader_0_CMD_GET_METADATA) */


            /***************************************************************************
            *   Verify application checksum (0x31)
            ***************************************************************************/
        #if (0u != Bootloader_0_CMD_VERIFY_APP_CHKSUM_AVAIL)     
            case Bootloader_0_COMMAND_CHECKSUM:

                if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 0u))
                {
                    packetBuffer[Bootloader_0_DATA_ADDR] =
                            (uint8)(Bootloader_0_ValidateBootloadable(Bootloader_0_activeApp) == CYRET_SUCCESS);

                    rspSize = Bootloader_0_RSP_SIZE_VERIFY_CHKSM;
                    ackCode = CYRET_SUCCESS;
                }
                break;
        #endif /* (0u != Bootloader_0_CMD_VERIFY_APP_CHKSUM_AVAIL) */

            /*****************************************************************************
            *   Verify row (0x45u)
            ***************************************************************************/
        #if(0u != Bootloader_0_CMD_VERIFY_FLS_ROW_AVAIL)
            case Bootloader_0_COMMAND_VERIFY_FLS_ROW:

                /* Packet size is either 3 (data is already in buffer) or (3u + Bootloader_0_FROW_SIZE),
                 * then data is in packetBuffer[]*/
                if ((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && ((3u == pktSize) || 
                   ((3u + Bootloader_0_FROW_SIZE) == pktSize)))
                {
                    uint16 CYDATA rowNum = ((uint16)((uint16)packetBuffer[Bootloader_0_DATA_ADDR + 2u] << 8u)) |
                                                             packetBuffer[Bootloader_0_DATA_ADDR + 1u];
                    ...
                    else 
                    {
                        ...
                        (void) memcpy(dataBuffer, &packetBuffer[Bootloader_0_DATA_ADDR + 3u],
                                      (int16)pktSize - 3);
                    #else              
                        /*Data is in packetBuffer[], needs to be copied to dataBuffer[]*/
                        (void) memcpy(dataBuffer, &packetBuffer[Bootloader_0_DATA_ADDR + 3u],
                ...
                #if (!CY_PSOC4) 
                    if((btldrData >= Bootloader_0_FIRST_EE_ARRAYID) &&
                       (btldrData <= Bootloader_0_LAST_EE_ARRAYID))
                    {
                        /* EEPROM */
                        ...
                        upperRange = Bootloader_0_NUMBER_OF_EEPROM_SECTORS * Bootloader_0_NUMBER_OF_ROWS_IN_EEPROM_SECTOR;
                    }
                    else if (btldrData < CY_FLASH_NUMBER_ARRAYS)    
                    {
                        ...
                        upperRange = Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY;                        
                    }
                    else
                    {
                        ackCode = Bootloader_0_ERR_ARRAY;
                        break;                              
                    }

                    /*Checking if row number is within array address range*/
                    ackCode = Bootloader_0_CHECK_ROW_NUMBER(rowNum, upperRange);
                    ...
                    ackCode = Bootloader_0_VerifyRow(startAddr, dataBuffer, rowSize);
                    ...
                    *******************************************************************************/                    
                        ...
                        if ((CYRET_SUCCESS == ackCode) && (btldrData < CY_FLASH_NUMBER_ARRAYS) && (dataOffset > rowSize))
                        {
                            ...
                            ackCode = Bootloader_0_VerifyRow(startAddr, &dataBuffer[rowSize], (uint16)CYDEV_ECC_ROW_SIZE);                        
                        }
                    ...
                    if (btldrData < CY_FLASH_NUMBER_ARRAYS)
                    {
                        ...
                        ackCode = Bootloader_0_VerifyRow(startAddr, dataBuffer, (uint16)CYDEV_FLS_ROW_SIZE);
                    }
                    else
                    {
                        ackCode = Bootloader_0_ERR_ARRAY;
                ...
                break;
        #endif /*(0u != Bootloader_0_CMD_VERIFY_ROW_FLS_AVAIL)*/

            /***************************************************************************
            *   Get flash size (0x32)
            ***************************************************************************/
            #if(0u != Bootloader_0_CMD_GET_FLASH_SIZE_AVAIL)

                case Bootloader_0_COMMAND_REPORT_SIZE:
                    ...
                    if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 1u))
                    {
                        if(btldrData < CY_FLASH_NUMBER_ARRAYS)
                        {
                            ...
                            *   then we do not use the Bootloader_0_SizeBytes and Bootloader_0_SizeBytesAccess 
                            *   variables, instead we take the Launcher's last row from metadata.
                            *******************************************************************************/
                        #if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) 
                            arrayIdBtlderEnds = (uint8) (*Bootloader_0_SizeBytesAccess / CY_FLASH_SIZEOF_ARRAY);

                            if (btldrData == arrayIdBtlderEnds)
                            {
                                startRow = (uint16) (*Bootloader_0_SizeBytesAccess / CY_FLASH_SIZEOF_ROW) %
                                            Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY;
                            }
                        #else /*Combination project type*/   
                            btldrLastRow = (uint16)(Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW, \
                                                                                Bootloader_0_MD_BTLDB_ACTIVE_0));
                            arrayIdBtlderEnds = (uint8) (((uint32)btldrLastRow * CY_FLASH_SIZEOF_ROW) / (uint32)CY_FLASH_SIZEOF_ARRAY); 
                            if (btldrData == arrayIdBtlderEnds)
                            {
                                startRow = (uint16)((btldrLastRow) % Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY);
                            }
                        #endif /*(CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/
                        
                            else if (btldrData > arrayIdBtlderEnds)
                            {
                                startRow = Bootloader_0_FIRST_ROW_IN_ARRAY;
                            }
                            else /* (btldrData < ArrayIdBtlderEnds) */
                            {
                                startRow = Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY;
                            }

                            packetBuffer[Bootloader_0_DATA_ADDR]      = LO8(startRow);
                            packetBuffer[Bootloader_0_DATA_ADDR + 1u] = HI8(startRow);

                            packetBuffer[Bootloader_0_DATA_ADDR + 2u] =
                                        LO8(Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY - 1u);

                            packetBuffer[Bootloader_0_DATA_ADDR + 3u] =
                                        HI8(Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY - 1u);

                            rspSize = Bootloader_0_RSP_SIZE_GET_FLASH_SIZE;
                            ackCode = CYRET_SUCCESS;
                        }
            ...
            #endif  /* (0u != Bootloader_0_CMD_GET_FLASH_SIZE_AVAIL) */
            ...
            ***************************************************************************/
                ...
                #if(0u != Bootloader_0_CMD_GET_APP_STATUS_AVAIL)

                    case Bootloader_0_COMMAND_APP_STATUS:

                        if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (1u == pktSize))
                        {

                            packetBuffer[Bootloader_0_DATA_ADDR] =
                                (uint8)Bootloader_0_ValidateBootloadable(btldrData);

                            packetBuffer[Bootloader_0_DATA_ADDR + 1u] =
                                (uint8) Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE, btldrData);

                            rspSize = Bootloader_0_RSP_SIZE_GET_APP_STATUS;
                            ackCode = CYRET_SUCCESS;
                        }
                        break;

                #endif  /* (0u != Bootloader_0_CMD_GET_APP_STATUS_AVAIL) */
            ...
            ***************************************************************************/
            case Bootloader_0_COMMAND_PROGRAM:

            /* btldrData variable holds Flash Array ID */

        #if (0u != Bootloader_0_CMD_ERASE_ROW_AVAIL)

            case Bootloader_0_COMMAND_ERASE:
                if (Bootloader_0_COMMAND_ERASE == packetBuffer[Bootloader_0_CMD_ADDR])
                {
                    if ((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 3u))
                    {
                        #if(!CY_PSOC4)
                            if((btldrData >= Bootloader_0_FIRST_EE_ARRAYID) &&
                               (btldrData <= Bootloader_0_LAST_EE_ARRAYID))
                            ...
                            else
                            {
                                ...
                                dataOffset = Bootloader_0_FROW_SIZE;
                            }
                        #else
        ...
        #endif  /* (0u != Bootloader_0_CMD_ERASE_ROW_AVAIL) */
                ...
                if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize >= 3u))
                {
                    ...
                    dataOffset += (pktSize - 3u);
                        ...
                        {
                            /* Size of flash row (depends on ECC configuration) */
                            pktSize = Bootloader_0_FROW_SIZE;                            
                            upperRange = Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY;
                        }
                    #else
                        /* Size of flash row (no ECC available) */
                    ...
                    if(dataOffset == pktSize)
                    {
                        ...
                        uint16 firstRow;    
                    #if ((0u != Bootloader_0_DUAL_APP_BOOTLOADER) && \
                          (1u == Bootloader_0_GOLDEN_IMAGE_AVAIL))
                        cystatus goldenImageValid;
                    #endif /*(((0u != Bootloader_0_DUAL_APP_BOOTLOADER) &&
                               (1u == Bootloader_0_GOLDEN_IMAGE_AVAIL))*/

                        /* Get flash/EEPROM row number inside array */
                        dataOffset = ((uint16)((uint16)packetBuffer[Bootloader_0_DATA_ADDR + 2u] << 8u)) |
                                              packetBuffer[Bootloader_0_DATA_ADDR + 1u];

                        /*Checking if row number is within array address range*/
                        ackCode = Bootloader_0_CHECK_ROW_NUMBER(dataOffset, upperRange);
                        ...
                        #if(!CY_PSOC4)
                            if(btldrData <= Bootloader_0_LAST_FLASH_ARRAYID)
                            {
                        #endif  /* (!CY_PSOC4) */
                
                        /* btldrData  - holds flash array Id sent by host */
                        /* dataOffset - holds flash row Id sent by host   */
                        row = (uint16)(btldrData * Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY) + dataOffset;
                        ...
                        *******************************************************************************/
                        ...
                        /* First empty flash row after Bootloader application */
                        #if (CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)    
                            firstRow = (uint16) (*Bootloader_0_SizeBytesAccess / CYDEV_FLS_ROW_SIZE);
                            if ((*Bootloader_0_SizeBytesAccess % CYDEV_FLS_ROW_SIZE) != 0u)
                            {
                                firstRow++;
                            }
                        #else /*Combination project type*/                       
                            
                            if (Bootloader_0_RUNNING_APPLICATION_0 == Bootloader_0_runningApp) 
                            {
                                btldrLastRow = (uint16)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW, 
                                                                            Bootloader_0_MD_BTLDB_ACTIVE_1);                            
                            }    
                            else /*(Bootloader_0_RUNNING_APPLICATION_1 == Bootloader_0_runningApp)*/
                            {
                                btldrLastRow = (uint16)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDR_LAST_ROW,
                                                                            Bootloader_0_MD_BTLDB_ACTIVE_0);
                            }
                            ...
                            ************************************************************************************/
                            ...
                            if (0u != app2StartAddress) 
                            {
                                ...
                                if(Bootloader_0_activeApp < Bootloader_0_MD_BTLDB_ACTIVE_NONE)    
                                {
                                    ...
                                    ackCode = Bootloader_0_CheckImage(Bootloader_0_activeApp, 
                                                                       btldrData, /*array number*/
                                                                       row,  /*row number*/
                                                                       dataOffset); /*row number in scope of array*/
                                
                                    if (Bootloader_0_ERR_ACTIVE == ackCode)
                                    {
                                        dataOffset = 0u;
                                        break;                                
                                    }
                            ...
                            ackCode = Bootloader_0_CheckImage(Bootloader_0_GOLDEN_IMAGE, 
                                                                  btldrData, /*array number*/
                                                                  row, /*row number*/
                                                                  dataOffset); /*row number in scope of array*/
                            ...
                            *************************************************************************/
                            goldenImageValid = Bootloader_0_ValidateBootloadable(Bootloader_0_GOLDEN_IMAGE);                          
                            if ((Bootloader_0_ERR_ACTIVE == ackCode) && (CYRET_SUCCESS == goldenImageValid))
                            {
                                dataOffset = 0u;
                                break;                                
                            }
                        ...
                        *******************************************************************************/
                            ...
                            if(0u == clearedMetaData)
                            {
                                ...
                                uint8 erase[Bootloader_0_FROW_SIZE];
                                uint8 Bootloader_0_notActiveApp;


                                #if(CY_PSOC3)
                                    (void) memset(erase, (char8) 0, (int16) Bootloader_0_FROW_SIZE);
                                #else
                                    (void) memset(erase, 0, Bootloader_0_FROW_SIZE);
                                #endif  /* (CY_PSOC3) */


                                #if ((0u != Bootloader_0_DUAL_APP_BOOTLOADER) || \
                                     (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER))
                                    if (Bootloader_0_MD_BTLDB_ACTIVE_0 == Bootloader_0_activeApp)
                                    {
                                        Bootloader_0_notActiveApp = Bootloader_0_MD_BTLDB_ACTIVE_1;
                                    }
                                    else
                                    {
                                        Bootloader_0_notActiveApp = Bootloader_0_MD_BTLDB_ACTIVE_0;
                                    }
                                #else
                                    Bootloader_0_notActiveApp = Bootloader_0_MD_BTLDB_ACTIVE_0;
                                #endif /* (0u != Bootloader_0_DUAL_APP_BOOTLOADER) */
                                    ...
                                    (void) CySysFlashWriteRow(
                                            Bootloader_0_MD_ROW_NUM(Bootloader_0_notActiveApp),
                                            erase);
                                #else
                                    (void) CyWriteRowFull(
                                            (uint8)  Bootloader_0_MD_FLASH_ARRAY_NUM,
                                            (uint16) Bootloader_0_MD_ROW_NUM(Bootloader_0_notActiveApp),
                                            erase,
                                            Bootloader_0_FROW_SIZE);
                                #endif  /* (CY_PSOC4) */
            ...
            ***************************************************************************/
            #if(0u != Bootloader_0_CMD_SYNC_BOOTLOADER_AVAIL)

            case Bootloader_0_COMMAND_SYNC:

                if(Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState)
                {
            ...
            #endif  /* (0u != Bootloader_0_CMD_SYNC_BOOTLOADER_AVAIL) */
            ...
            ***************************************************************************/
                ...
                case Bootloader_0_COMMAND_APP_ACTIVE:

                    if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 1u))
                    {
                        if(CYRET_SUCCESS == Bootloader_0_ValidateBootloadable(btldrData))
                        {
                            Bootloader_0_SetActiveAppInMetadata(btldrData);
                            Bootloader_0_activeApp = btldrData;
                            ackCode = CYRET_SUCCESS;
                        }
                        else
                        {
            ...
            *   Send data (0x37)
            ***************************************************************************/
            #if (0u != Bootloader_0_CMD_SEND_DATA_AVAIL)

                case Bootloader_0_COMMAND_DATA:

                    if(Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState)
                    {
                        /*  Make sure that dataOffset is valid before copying data */
                        if((dataOffset + pktSize) <= Bootloader_0_SIZEOF_COMMAND_BUFFER)
                        {
                            ackCode = CYRET_SUCCESS;
            ...
            #endif  /* (0u != Bootloader_0_CMD_SEND_DATA_AVAIL) */


            /***************************************************************************
            *   Enter bootloader (0x38)
            ***************************************************************************/
            case Bootloader_0_COMMAND_ENTER:

        #if (Bootloader_0_SECURITY_KEY_AVAIL == 1u)    
            if(pktSize == 6u) /*Security key*/
        #else    
            if(pktSize == 0u) /*Security key is not demanded*/
        #endif /*(Bootloader_0_SECURITY_KEY_AVAIL == 1u)*/   
                {
                    #if(CY_PSOC3)

                        Bootloader_0_ENTER CYDATA BtldrVersion =
                            {CYSWAP_ENDIAN32(CYDEV_CHIP_JTAG_ID), CYDEV_CHIP_REV_EXPECT, Bootloader_0_VERSION};

                    #else

                        Bootloader_0_ENTER CYDATA BtldrVersion =
                            {CYDEV_CHIP_JTAG_ID, CYDEV_CHIP_REV_EXPECT, Bootloader_0_VERSION};
            #endif  /* (CY_PSOC3) */

            #if (Bootloader_0_SECURITY_KEY_AVAIL == 1u)
                
                /*Security key checking*/
                uint8 idx = Bootloader_0_SECURITY_KEY_LENGTH;
                ackCode = CYRET_SUCCESS;
                
                do
                {
                    idx--;                     
                    if (Bootloader_0_securityKey[idx] != packetBuffer[Bootloader_0_DATA_ADDR + idx])
                    {
                        ackCode = Bootloader_0_ERR_DATA;
                        break;
                    }
                ...
                if (Bootloader_0_ERR_DATA == ackCode)
                {
                    break;
                }
            #endif /*(Bootloader_0_SECURITY_KEY_AVAIL == 1u)*/
                ...
                #if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) 
                    Bootloader_0_isBootloading = Bootloader_0_BOOTLOADING_IN_PROGRESS;
                #endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/    
                
                    communicationState = Bootloader_0_COMMUNICATION_STATE_ACTIVE;

                    rspSize = sizeof(Bootloader_0_ENTER);
                    dataOffset = 0u; 
            ...
            ***************************************************************************/
            #if (0u != Bootloader_0_CMD_GET_ROW_CHKSUM_AVAIL)

            case Bootloader_0_COMMAND_GET_ROW_CHKSUM:
                ...
                if((Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 3u))
                {
                    ...
                    uint16 CYDATA tmpRowNum; 
                           ...
                           (btldrData <= Bootloader_0_LAST_EE_ARRAYID))
                        {
                            ...
                            /* Checking if row number is within array address range */
                            ackCode = Bootloader_0_CHECK_ROW_NUMBER(rowNum, 
                                (Bootloader_0_NUMBER_OF_EEPROM_SECTORS * Bootloader_0_NUMBER_OF_ROWS_IN_EEPROM_SECTOR));
                            ...
                            checksum = Bootloader_0_Calc8BitSum(CY_EEPROM_BASE, rowAddr, CYDEV_EEPROM_ROW_SIZE);
                        }
                        else
                        {
                            /* flash */ 
                            ...
                            checksum = Bootloader_0_Calc8BitSum(CY_FLASH_BASE, rowAddr, CYDEV_FLS_ROW_SIZE);
                        }
                    ...
                    * correct.
                     ******************************************************************************/
                        ...
                        tmpRowNum = rowNum; 
                    #else
                        tmpRowNum = rowNum + ((uint16)(Bootloader_0_NUMBER_OF_ROWS_IN_ARRAY * btldrData));
                    #endif
                    
                    if((Bootloader_0_MD_FLASH_ARRAY_NUM == btldrData) && (Bootloader_0_CONTAIN_METADATA(tmpRowNum)))
                    {

                        checksum -= (uint8)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_ACTIVE,
                                                                 Bootloader_0_GET_APP_ID(tmpRowNum));

                        checksum -= (uint8)Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_STATUS,
                                                                 Bootloader_0_GET_APP_ID(tmpRowNum));
                    }

                    packetBuffer[Bootloader_0_DATA_ADDR] = (uint8)1u + (uint8)(~checksum);
                    ackCode = CYRET_SUCCESS;
                    rspSize = Bootloader_0_RSP_SIZE_VERIFY_ROW_CHKSM;
                }
                break;

            #endif /* (0u != Bootloader_0_CMD_GET_ROW_CHKSUM_AVAIL) */


            /***************************************************************************
            *   Exit bootloader (0x3B)
            ***************************************************************************/
            case Bootloader_0_COMMAND_EXIT:
                ...
                *******************************************************************************/
            #if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
                needToCopyFlag = Bootloader_0_GetMetadata(Bootloader_0_GET_BTLDB_COPY_FLAG, 
                                                        Bootloader_0_MD_BTLDB_ACTIVE_1);                                                    
        
                /* Checking "Need to copy" flag in metadata#1 */
                if (0u != (needToCopyFlag & Bootloader_0_NEED_TO_COPY_MASK))
                {  
                    Bootloader_0_SET_RUN_TYPE(Bootloader_0_SCHEDULE_BTLDR);
                }
                else
            #endif /* (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER) */
        
                if(CYRET_SUCCESS == Bootloader_0_ValidateBootloadable(Bootloader_0_activeApp))
                {
                    Bootloader_0_SET_RUN_TYPE(Bootloader_0_SCHEDULE_BTLDB);
                }
                
            #if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
                Bootloader_0_isBootloading = Bootloader_0_BOOTLOADING_COMPLETED;
            #endif /* CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER */    
            ...
            ***************************************************************************/
            ...
            #if (!CY_PSOC3)
                if ((NULL != Bootloader_0_callback) && (Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState))
                {
                    Bootloader_0_in_packet_type Bootloader_0_inPacket; 
                    Bootloader_0_out_packet_type Bootloader_0_outPacket;

                    /* Initializing input packet */
                    Bootloader_0_inPacket.command = packetBuffer[Bootloader_0_CMD_ADDR];
                    Bootloader_0_inPacket.packetLength = pktSize;
                    Bootloader_0_inPacket.pInputBuffer = &packetBuffer[Bootloader_0_DATA_ADDR];
                                        
                    /* Clearing and setting output packet */
                    (void) memset(&Bootloader_0_outPacket, 0, sizeof(Bootloader_0_outPacket));
                    Bootloader_0_outPacket.pOutputBuffer = &packetBuffer[Bootloader_0_DATA_ADDR];
                    
                    /* Callback */
                    (void) Bootloader_0_callback(&Bootloader_0_inPacket, &Bootloader_0_outPacket);

                    rspSize = Bootloader_0_outPacket.packetLength;
                    if (((rspSize > (Bootloader_0_SIZEOF_COMMAND_BUFFER - Bootloader_0_MIN_PKT_SIZE)) && 
                         (Bootloader_0_outPacket.pOutputBuffer == &packetBuffer[Bootloader_0_DATA_ADDR])) ||
                        ((NULL == Bootloader_0_outPacket.pOutputBuffer) && (0u != rspSize)))
                    {                    
                        /* One of returned parameters is wrong */
                        ackCode = Bootloader_0_ERR_CALLBACK;
                        rspSize = 0u;
                    }
                    else /* Everything is OK */
                    {
                        ackCode = (uint8)Bootloader_0_outPacket.status;
                    }
                }    
                else /* No callback function defined, so return "Error Command" status */
            #endif /* (!CY_PSOC3) */
                {
                    ackCode = Bootloader_0_ERR_CMD;
                }    
                break;
            }
        }
        ...
        (void) Bootloader_0_WritePacket(ackCode, packetBuffer, rspSize);
   
    } while ((0u == timeOut) || (Bootloader_0_COMMUNICATION_STATE_ACTIVE == communicationState));
}


/*******************************************************************************
* Function Name: Bootloader_0_WritePacket
****************************************************************************//**
* \internal
*
* \brief
                                            ...
                                            
{
    ...
    /* Start of packet. */
    buffer[Bootloader_0_SOP_ADDR]      = Bootloader_0_SOP;
    buffer[Bootloader_0_CMD_ADDR]      = status;
    buffer[Bootloader_0_SIZE_ADDR]     = LO8(size);
    buffer[Bootloader_0_SIZE_ADDR + 1u] = HI8(size);

    /* Compute checksum. */
    checksum = Bootloader_0_CalcPacketChecksum(buffer, size + Bootloader_0_DATA_ADDR);

    buffer[Bootloader_0_CHK_ADDR(size)]     = LO8(checksum);
    buffer[Bootloader_0_CHK_ADDR(1u + size)] = HI8(checksum);
    buffer[Bootloader_0_EOP_ADDR(size)]     = Bootloader_0_EOP;

    /* Start packet transmit. */
    return(CyBtldrCommWrite(buffer, size + Bootloader_0_MIN_PKT_SIZE, &size, 150u));
}
#endif /*(CYDEV_PROJ_TYPE != CYDEV_PROJ_TYPE_LAUNCHER)*/

/*******************************************************************************
* Function Name: Bootloader_0_SetFlashByte
****************************************************************************//**
*
* \brief
...
void Bootloader_0_SetFlashByte(uint32 address, uint8 runType) 
{
    ...
    for(idx = 0u; idx < CYDEV_FLS_ROW_SIZE; idx++)
    {
        rowData[idx] = Bootloader_0_GET_CODE_BYTE(baseAddr + idx);
    }
...
/*******************************************************************************
* Function Name: Bootloader_0_GetMetadata
****************************************************************************//**
*
* \brief
...
uint32 Bootloader_0_GetMetadata(uint8 field, uint8 appId)
{
    ...
    switch (field)
    {
    case Bootloader_0_GET_BTLDB_CHECKSUM:
        fieldPtr  = Bootloader_0_MD_BTLDB_CHECKSUM_OFFSET(appId);
        fieldSize = 1u;
        break;   

    case Bootloader_0_GET_BTLDB_ADDR:
        fieldPtr  = Bootloader_0_MD_BTLDB_ADDR_OFFSET(appId);
    #if(!CY_PSOC3)
        fieldSize = 4u;
    #endif  /* (!CY_PSOC3) */
        break;

    case Bootloader_0_GET_BTLDR_LAST_ROW:
        fieldPtr  = Bootloader_0_MD_BTLDR_LAST_ROW_OFFSET(appId);
        break;

    case Bootloader_0_GET_BTLDB_LENGTH:
        fieldPtr  = Bootloader_0_MD_BTLDB_LENGTH_OFFSET(appId);
    #if(!CY_PSOC3)
        fieldSize = 4u;
    #endif  /* (!CY_PSOC3) */
        break;

    case Bootloader_0_GET_BTLDB_ACTIVE:
        fieldPtr  = Bootloader_0_MD_BTLDB_ACTIVE_OFFSET(appId);
        fieldSize = 1u;
        break;

    case Bootloader_0_GET_BTLDB_STATUS:
        fieldPtr  = Bootloader_0_MD_BTLDB_VERIFIED_OFFSET(appId);
        fieldSize = 1u;
        break;

    case Bootloader_0_GET_BTLDB_APP_VERSION:
        fieldPtr  = Bootloader_0_MD_BTLDB_APP_VERSION_OFFSET(appId);
        break;

    case Bootloader_0_GET_BTLDR_APP_VERSION:
        fieldPtr  = Bootloader_0_MD_BTLDR_APP_VERSION_OFFSET(appId);
        break;

    case Bootloader_0_GET_BTLDB_APP_ID:
        fieldPtr  = Bootloader_0_MD_BTLDB_APP_ID_OFFSET(appId);
        break;

    case Bootloader_0_GET_BTLDB_APP_CUST_ID:
        fieldPtr  = Bootloader_0_MD_BTLDB_APP_CUST_ID_OFFSET(appId);
        fieldSize = 4u;
        break;
        
    case Bootloader_0_GET_BTLDB_COPY_FLAG:
        fieldPtr = Bootloader_0_MD_BTLDB_COPY_FLAG_OFFSET(appId);
        fieldSize = 1u;
        break;        

    case Bootloader_0_GET_BTLDB_USER_DATA:
        fieldPtr = Bootloader_0_MD_BTLDB_USER_DATA_OFFSET(appId);
        fieldSize = 4u;
        break;        
