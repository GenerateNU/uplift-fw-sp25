...
#ifdef UART_0_SPI_UART_ISR_ENTRY_CALLBACK
    UART_0_SPI_UART_ISR_EntryCallback();
#endif /* UART_0_SPI_UART_ISR_ENTRY_CALLBACK */
    ...
    #if (UART_0_CHECK_RX_SW_BUFFER)
    {
        if (UART_0_CHECK_INTR_RX_MASKED(UART_0_INTR_RX_NOT_EMPTY))
        {
            do
            {
                ...
                if (UART_0_INTERNAL_RX_BUFFER_SIZE == locHead)
                {
                    locHead = 0u;
                }
                ...
                {
                    /* Store received data */
                    UART_0_PutWordInRxBuffer(locHead, UART_0_RX_FIFO_RD_REG);
...
#ifdef UART_0_SPI_UART_ISR_EXIT_CALLBACK
    UART_0_SPI_UART_ISR_ExitCallback();
#endif /* UART_0_SPI_UART_ISR_EXIT_CALLBACK */
