...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B00), 0x80000077u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F324Eu, /* Base address: 0x400F3200 Count: 78 */
			0x400F332Eu, /* Base address: 0x400F3300 Count: 46 */
			0x400F4013u, /* Base address: 0x400F4000 Count: 19 */
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00000333u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00C90000u);
		...
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x000001FDu);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_REG32((void *)(CYREG_UDB_INT_CFG), 0x000001FEu);
